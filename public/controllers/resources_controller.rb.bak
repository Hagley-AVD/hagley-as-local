...
# Pry::ColorPrinter.pp @results['results'][0]['_resolved_resource']['json']
  ...
  def show
    ...
    begin
      @criteria = {}
      @criteria['resolve[]'] = ['repository:id', 'resource:id@compact_resource', 'top_container_uri_u_sstr:id', 'related_accession_uris:id','linked_instances_uris:id', 'digital_object_uris:id']
